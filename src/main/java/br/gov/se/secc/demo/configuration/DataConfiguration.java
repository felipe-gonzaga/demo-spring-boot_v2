...
import static br.gov.se.sefaz.util.DataUtil.DDMMAAAA_BARRA;
import static br.gov.se.sefaz.util.DataUtil.DDMMAAAA_HHMMSS_BARRA;
import static br.gov.se.sefaz.util.DataUtil.HHMMSS_DOIS_PONTOS;
...
public class DataConfiguration {
	...
	@PersistenceContext(unitName = DemoConfiguration.ENTITY_MANAGER_FACTORY)
